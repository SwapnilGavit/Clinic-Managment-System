...
function Footer() {
  return (
    <footer className="text-gray-600 bottom-0 w-full body-font    ">
      <div className=" px-10  bg-indigo-300 py-12 mx-auto " >
      ...
      <div className="bg-indigo-400">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <img src="https://img.icons8.com/external-obvious-flat-kerismaker/48/000000/external-clinic-infirmary-flat-obvious-flat-kerismaker-32.png" />
            ...
            <span className="ml-3 text-xl">Gandhi's Clinic      </span>
            <span className="ml-6 justify-center">© 2022 All Right Reserved By Gandhi's Clinic</span>
           </a>
